...
func (p *coreFuncProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	...
	return []func() datasource.DataSource{
		EnvEnsureDataSource,
		HashArgon2idBase64DataSource,
		HashArgon2idDataSource,
		HashBcryptDataSource,
		HashHmacBase64sha256DataSource,
		HashHmacSha256DataSource,
		HashMd5Base64DataSource,
		HashMd5DataSource,
		HashScryptBase64DataSource,
		HashScryptDataSource,
		...
		StrByteLengthDataSource,
		StrCamelDataSource,
		StrConstantDataSource,
		StrContainsDataSource,
		...
		StrPascalDataSource,
		StrSnakeDataSource,
		StrStartswithDataSource,
		TimeCompareDataSource,
		TimeParseDataSource,
...
func (p *coreFuncProvider) Functions(ctx context.Context) []func() function.Function {
	...
	return []func() function.Function{
		EnvEnsureFunction,
		HashArgon2idBase64Function,
		HashArgon2idFunction,
		HashBcryptFunction,
		HashHmacBase64sha256Function,
		HashHmacSha256Function,
		HashMd5Base64Function,
		HashMd5Function,
		HashScryptBase64Function,
		HashScryptFunction,
